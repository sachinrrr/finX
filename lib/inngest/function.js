...
async function generateGeminiContent({ apiKey, apiVersion, model, prompt }) {
...
async function generateFinancialInsights(stats, month) {
  ...
  try {
    ...
    let responseJson;
    try {
      responseJson = await generateGeminiContent({ apiKey, apiVersion: "v1", model, prompt });
    } catch (e) {
      responseJson = await generateGeminiContent({ apiKey, apiVersion: "v1beta", model, prompt });
    }
