  ...
  async ({ event, step }) => {
    ...
    await step.run("process-transaction", async () => {
      ...
      await db.$transaction(async (tx) => {
        // Calculate next recurring date based on the ORIGINAL transaction date pattern
        // This preserves the day of month (e.g., 25th stays 25th)
        ...
        // Mark it as recurring so it shows the recurring indicator in the UI
        ...
        // Update the original recurring transaction metadata
