        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            {statsData.map((stat, index) => (
              <div
                key={index}
                className="group text-center p-8 rounded-lg bg-card border border-border hover:bg-muted transition-colors"
              >
                <div className="text-3xl md:text-4xl font-semibold tracking-tight tabular-nums text-foreground mb-2">
                  {stat.value}
                </div>
